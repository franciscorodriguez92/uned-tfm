...
\noindent Motivación del trabajo a realizar.\todo{Ejemplo de TODO: a completar}

El primer párrafo de cada sección no se indenta, los siguientes sí.
Las referencias a un artículo del estado del arte se ponen así: El trabajo \cite{Agirre2009} bla bla.
