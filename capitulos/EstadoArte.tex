...
Para evaluar el acuerdo entre los etiquetadores, se ha utilizado la medida \textit{kappa de Cohen} \cite{Cohen1960}. Este coeficiente mide la concordancia entre dos examinadores en sus clasificaciones de un conjunto de documentos en distintas categorías. La expresión se calcula del siguiente modo:
