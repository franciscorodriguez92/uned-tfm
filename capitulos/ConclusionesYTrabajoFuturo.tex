...
Sería recomendable la creación de un léxico machista específico para el español que permita añadir atributos en el entrenamiento del sistema para detectar aquellos términos que más se repitan en los mensajes machistas. Este tipo de enfoque ha demostrado su efectividad en trabajos similares \cite{Wahyu2018} y se podrían implementar mediante léxicos disponibles en la bibliografía \cite{Mauro2016}.
