...
\noindent Para valorar el acuerdo alcanzado por los etiquetadores en su labor se ha optado por la evaluación del coeficiente kappa de Cohen \todo{Añadir definición teórica en la evaluación}. 

Se realizó una evaluación de la medida kappa en 2 puntos: al haber etiquetado el 20\% de todo el corpus y al etiquetar el corpus completo. En la primera evaluación, se obtuvieron los resultados de la tabla 4.3. En este caso, se valoró que para el número de clases distintas este valor del coeficiente kappa era insuficiente y se revisaron los patrones de etiquetas propuestos por cada uno de los etiquetadores. De este modo, se detectaron los siguientes problemas:
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lll}
			& Kappa &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-2\end{tabular} & 0,5 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-3\end{tabular} & 0,44 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   2-3\end{tabular} & 0,58 &  \\
			\textbf{Media Etiquetadores} & \textbf{0,51} & 
		\end{tabular}%
	}
	\caption{My caption}
	\label{my-label}
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lll}
			& Kappa &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-2\end{tabular} & 0,76 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-3\end{tabular} & 0,78 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   2-3\end{tabular} & 0,74 &  \\
			\textbf{Media Etiquetadores} & \textbf{0,76} & 
		\end{tabular}%
	}
	\caption{My caption}
	\label{my-label}
...
\begin{table}[]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{lll}
			& Kappa &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-2\end{tabular} & 0,68 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   1-3\end{tabular} & 0,68 &  \\
			\begin{tabular}[c]{@{}l@{}}Etiquetador\\   2-3\end{tabular} & 0,88 &  \\
			\textbf{Media Etiquetadores} & \textbf{0,75} & 
		\end{tabular}%
	}
	\caption{My caption}
	\label{my-label}
